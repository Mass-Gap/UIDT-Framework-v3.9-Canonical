...
| **Torsion Energy**| E_T| 2.44 MeV  | — | C | Torsion |
| **RG Cascade**    | N  | 94.05     | — | C/D | Topological truth baseline |
...
| **Holographic L**   | L   | 8.2        | ±0.1 | C | Holographic length parameter |
...
|---------|------|-------------|
| v3.9   | 2026-02-28 | N=94.05 topological baseline, w_0=-0.99, w_a=-1.30, L=8.2 |
...
N   = 94.05               [C/D] Topological truth baseline
```
