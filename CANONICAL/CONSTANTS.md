# UIDT Canonical Constants v3.9

> **STATUS:** Immutable until next version update
> **SOURCE:** Framework v3.9, DOI: 10.5281/zenodo.17835200
...
| **Torsion Energy**| E_T| 2.44 MeV  | — | D | Effective IR term — NOT from Dyson loop integral |
| **RG Cascade (bare)** | N_bare | 99 | — | D | Unrenormalized lattice limit |
| **RG Cascade (eff.)** | N_eff | 94.05 | — | E | Renormalized RG-flow (conjectured: N_bare × 0.95) |
...
| **Dark Energy**     | w_0 | -0.99      | — | C | Canonical dark energy |
| **Holographic L**   | L   | ~8.2       | — | D/E | DERIVED, not fundamental — assumed for w_a calculation, NOT canonical (see Decision D-003) |
| **Dark Energy wa**  | w_a | -1.30      | — | C | Holographic dark energy parameter |
...
|---------|------|-------------|
| v3.9   | 2026-02-28 | N_bare=99 [D] / N_eff=94.05 [E], w_0=-0.99 [C], w_a=-1.30 [C], L~8.2 [D/E] derived |
| v3.7.2 | 2025-12-20 | Current canonical, VEV=47.7 MeV, H₀=70.4 |
...
w_0 = -0.99               [C] Canonical dark energy
w_a = -1.30               [C] Holographic dark energy
L   = ~8.2 (derived)      [D/E] NOT canonical — assumed for calculations
N_bare = 99               [D]  Unrenormalized lattice limit
N_eff  = 94.05             [E]  Conjectured renormalized (= 99 × 0.95)
```
