...
# --- Path injection (same pattern as UIDT_Master_Verification.py lines 45-47) ---
...
def run_csf_verification():
    ...
    print(f"  w_0 = {eos['w_0']}  (residual: {residual_w0})")
    print(f"  w_a = {eos['w_a']}  (residual: {residual_wa})")
