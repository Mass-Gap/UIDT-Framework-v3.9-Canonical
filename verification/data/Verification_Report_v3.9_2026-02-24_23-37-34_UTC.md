...
- Electron Ratio (UIDT/Obs): `0.767200`
- Implied sin²(θ_W): `0.232800`
- Muon Consistency Check: `FAILED`
...
[7] L2 CANDIDATE: ELECTROWEAK MIXING [Category D]...
   > Electron Ratio: 0.7672
   > Implied sin²(θ_W): 0.2328
   > Muon Consistency: FAILED
```
