...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{manuscript/figures/fig_eft_operator_dimensions.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.86\textwidth]{manuscript/figures/fig_desi_uidt_tension.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{manuscript/figures/fig_falsification_exposure.pdf}
...
\midrule
C4 & Scalar self-coupling & $\lambda_S\equiv5\kappa^2/3=5/12$ & \catmark{A} &
