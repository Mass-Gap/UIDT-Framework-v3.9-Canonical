...
$\Delta = \DeltaGap$ \catmark{A-} within the UIDT axiom system;
...
Submission context: the manuscript is intended for \texttt{hep-th} as primary
arXiv category, with \texttt{physics.hist-ph} as a possible cross-listing.
\end{abstract}
...
\begin{tabular}{@{}p{3.6cm}p{2.4cm}p{3.1cm}p{4.5cm}c@{}}
\toprule
...
\begin{tabular}{@{}p{1.1cm}p{3.0cm}p{2.1cm}p{1.2cm}p{1.1cm}p{2.7cm}p{1.4cm}p{2.2cm}@{}}
\toprule
...
metric. The vacuum configuration is locally fixed by the Banach contraction of
...
{\setlength{\tabcolsep}{2pt}
\begin{tabular}{@{}p{2.0cm}p{4.4cm}p{2.5cm}p{1.3cm}p{1.5cm}p{3.4cm}@{}}
\toprule
...
status of each claim inside the UIDT v3.9 repository governance model.
...
pending PI-authorised recalibration. UIDT-C-046/050 denotes internal exploratory
...
{\setlength{\tabcolsep}{3pt}
\begin{tabular}{@{}p{4.1cm}p{7.2cm}p{3.0cm}@{}}
\toprule
...
{\setlength{\tabcolsep}{2pt}
\begin{tabular}{@{}p{3.0cm}p{4.8cm}p{4.6cm}p{1.9cm}@{}}
\toprule
...
EFT non-renormalisability & The dimension-5 operator is explicitly treated as
...
\begin{center}
\itshape
As soon as there is distinction, there is being.\\
As soon as being is sufficiently complex, there is thought.\\[1em]
{\small Original German:}\\
{\small Sobald Unterscheidung ist, ist Sein.\\
