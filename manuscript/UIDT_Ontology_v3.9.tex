...
energy $E_T = 2.44\,\MeV$, with dynamics governed by the \UIDT\ Lagrangian
\eqref{eq:lagrangian} and coupling constant $\kappa = 0.5$. In an effective
...
\begin{enumerate}
  ...
  threshold $E_T = 2.44\,\MeV$ the dynamics remain effectively reversible
