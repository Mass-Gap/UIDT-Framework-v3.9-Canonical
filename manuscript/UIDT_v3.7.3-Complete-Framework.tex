...
%=============================================================================
\hypersetup{
    pdftitle={Vacuum Information Density as the Fundamental Geometric Scalar (UIDT v3.7.3)},
    pdfauthor={Philipp Rietz},
    pdfsubject={Unified Information-Density Theory (UIDT) v3.7.3 Complete Framework},
    pdfkeywords={Physics, Yang-Mills Mass Gap, Gamma Scaling, UIDT, Holographic Principle},
...
\subsection{Principal Advances (v3.6 \texorpdfstring{$\to$}{->} v3.7.3)}
...
\noindent\begin{minipage}{\textwidth}
    ...
    \node[font=\footnotesize\scshape\bfseries, text=black!70] at (4.5, 6.5) {Architecture of Reality};
...
\raggedright
\textbf{Source:} \\
\href{https://github.com/Mass-Gap/UIDT-Framework-v3.7.2-Canonical/blob/main/Supplementary_Scripts/uidt_proof_core.py}{\texttt{uidt\_proof\_core.py}}\hspace{0pt}
\end{quote}
...
\raggedright
\textbf{Source:}  \\
\href{https://github.com/Mass-Gap/UIDT-Framework-v3.7.2-Canonical/blob/main/Supplementary_Scripts/uidt_visualizer.py}{\texttt{uidt\_visualizer.py}}
\end{quote}
