...
%=============================================================================
% UIDT v3.7.3 - FINAL CANONICAL VERSION
%=============================================================================
% Created: 2025
...
% --- Evidence Categories (A/B/C/D/E) mit Farbmarkierungen -------------------
\definecolor{catAcolor}{RGB}{0,100,0}      % Category A: Dunkelgrün
\definecolor{catBcolor}{RGB}{34,139,34}    % Category B: Grün
\definecolor{catCcolor}{RGB}{255,140,0}    % Category C: Orange
\definecolor{catDcolor}{RGB}{220,20,60}     % Category D: Rot (Unverified Prediction)
\definecolor{catEcolor}{RGB}{139,0,139}     % Category E: Violett (Disputed)
...
% --- tcolorbox für Alerts -------------------------------------------------
\usepackage{tcolorbox}

% --- Version History Notice -----------------------------------------------
\newcommand{\versionnotice}{
\begin{tcolorbox}[colback=yellow!10!white,colframe=red!75!black,title=\textbf{Version History Notice}]
\vspace{0.3em}
...
% --- CRITICAL OPEN PROBLEM Alert -----------------------------------------
\newcommand{\criticalopenproblem}{
\begin{tcolorbox}[colback=red!10!white,colframe=red!75!black,title=\textbf{CRITICAL OPEN PROBLEM: $10^{10}$ Holographic Scale Factor}]
\vspace{0.3em}
The relation between the theoretical holographic information length $\ell_{\text{theo}} \approx 10^{-20}\,\text{m}$ and the empirically calibrated holographic scale $\lambda_{\text{UIDT}} \approx 0.66\,\text{nm}$ requires a geometric scaling factor of order $10^{10}$.
\vspace{0.3em}\
\textbf{Status:} This factor lacks rigorous first-principles derivation and represents the most significant unresolved challenge in the framework.
\end{tcolorbox}
}
...
% --- TITELPAGE -------------------------------------------------------------
\title{
    \textbf{UIDT v3.7.3 Canonical} \\ 
    \vspace{0.5cm}
    \Large\textbf{Universal Information Density Theory} \\ 
    \vspace{0.3cm}
    \large{A Mathematical Framework for Yang--Mills Mass Gap and Cosmological Phenomena}
}
\author{Philipp Rietz}
\date{Version 3.7.3 \ February 2026}
\maketitle
...
\begin{abstract}
\noindent
This manuscript presents the Universal Information Density Theory (UIDT), a mathematically self-consistent framework proposing that vacuum information density governs Yang--Mills mass gap and cosmological phenomena. The theory derives a mass gap $\newcommand{\Deltavalue}{1.710 \pm 0.015}\Deltavalue\,\GeV$ from first principles, predicts a universal invariant $\gamma = 16.339$, and provides falsifiable predictions for laboratory and cosmological tests. All results are classified by evidence categories (A--D) to ensure scientific transparency regarding theoretical status versus experimental confirmation.
\end{abstract}
