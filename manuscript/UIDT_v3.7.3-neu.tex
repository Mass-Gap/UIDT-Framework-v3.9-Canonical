...
%  Version 3.7.3: Complete Manuscript with Three-Pillar Architecture Integration
%  
...
%  Version: 3.7.3 (Complete Edition with Three-Pillar Architecture)
%
...
%
%  DESCRIPTION: Unified Information-Density Theory (UIDT v3.7.3) develops a vacuum
...
\fancypagestyle{uidtsecure}{%
  ...
  \fancyhead[RE]{\small\textit{UIDT v3.7.3: Vacuum Information Density}}
  \fancyhead[LO]{\small\textit{P. Rietz}}
  \fancyfoot[C]{%
    \thepage \\
    \vspace{0.1cm}
    \footnotesize\textcolor{darkgray}{%
       © 2025 P. Rietz $\cdot$ CC BY 4.0 $\cdot$ \href{https://doi.org/10.5281/zenodo.17835200}{\textcolor{darkgray}{DOI: 10.5281/zenodo.17835200}}%
    }
    \makebox[0pt][c]{%
      \scalebox{0.01}{%
        \textcolor{white}{%
...
\usepackage{hyperxmp}
\hypersetup{
    pdftitle={Universal Gamma Scaling: Information Geometry Unifies Quantum Gravity, Mass Gap & Cosmic Anomalies (UIDT v3.7.3)},
    pdfauthor={Philipp Rietz},
    pdfsubject={Unified Information-Density Theory (UIDT) v3.7.3 Complete Framework},
    pdfkeywords={
    ...
    pdfcreator={UIDT Complete Compilation v3.7.3},
        ...
        \textcolor{white}{%
            {
              ...
              "alternateName": "UIDT v3.7.3 Complete Framework with Three-Pillar Architecture",
...
\begin{tcolorbox}[
    ...
    \centering
    % Bild
    \href{https://github.com/Mass-Gap/UIDT-Framework-v3.7.2-Canonical/blob/main/Suplememtary_Figures/uidt_visualize1.png?raw=true}{%
    ...
    \begin{minipage}{\dimexpr\linewidth-2.5em}
        ...
        \href{https://github.com/Mass-Gap/UIDT-Framework-v3.7.2-Canonical/blob/main/Suplememtary_Figures/uidt_visualize2.png?raw=true}{%
...
\textbf{GitHub Repository:} \url{https://github.com/Mass-Gap/UIDT-Framework-v3.7.2-Canonical}

\noindent
\textbf{License:} MIT License (code) / CC-BY-4.0 (data and documentation)

\noindent
The repository is organized into three principal directories. All file names
correspond to the canonical v3.7.3 release archived on Zenodo.
...
\begin{itemize}
    \item 17 specialized verification scripts covering BRST cohomology
          (\texttt{brst\_cohomology\_verification.py}), Gribov copy analysis
          (\texttt{gribov\_analysis\_verification.py},
          \texttt{gribov\_suppression\_verification.py}), homotopy deformation
          (\texttt{homotopy\_deformation\_verification.py}), Slavnov--Taylor identities
          (\texttt{slavnov\_taylor\_ccr\_verification.py}), domain analysis
          (\texttt{domain\_analysis\_verification.py}), Osterwalder--Schrader axioms
          (\texttt{os\_axiom\_verification.py}), SHA-256 integrity checksums
          (\texttt{checksums\_sha256\_gen.py}), and composite Clay audit pipelines
          (\texttt{UIDT\_Clay\_Verifier.py}, \texttt{UIDT\_Proof\_Engine.py},
          \texttt{uidt\_complete\_clay\_audit.py})
\end{itemize}
...
\begin{itemize}
    \item \textbf{Zenodo Archive (Canonical):}
          ...
          Contains the complete UIDT framework v3.7.3, mathematical appendix, HMC
...
\texttt{clay-submission/02\_VerificationCode/checksums\_sha256\_gen.py}, which
...
\begin{quote}
\textbf{Source:} \\
\href{https://github.com/Mass-Gap/UIDT-Framework-v3.7.2-Canonical/blob/main/Supplementary_Scripts/uidt_proof_core.py}{UIDT-Framework V3.2 Canonical – Supplementary\_Scripts/uidt\_proof\_core.py}
\end{quote}
...
\begin{verbatim}
# Using wget
wget https://raw.githubusercontent.com/Mass-Gap/UIDT-Framework-v3.7.2-Canonical/main/Supplementary_Scripts/uidt_proof_core.py -O uidt_proof_core.py

# Alternatively with curl
curl -L https://raw.githubusercontent.com/Mass-Gap/UIDT-Framework-v3.7.2-Canonical/main/Supplementary_Scripts/uidt_proof_core.py -o uidt_proof_core.py
\end{verbatim}
}
...
\begin{quote}
\textbf{Source:}  \\
\href{https://github.com/Mass-Gap/UIDT-Framework-v3.7.2-Canonical/blob/main/Supplementary_Scripts/uidt_visualizer.py}{UIDT-Framework V3.2 Canonical – Supplementary\_Scripts/uidt\_visualizer.py}
\end{quote}
...
\begin{verbatim}
# Using wget
wget https://raw.githubusercontent.com/Mass-Gap/UIDT-Framework-v3.7.2-Canonical/main/Supplementary_Scripts/uidt_visualizer.py -O uidt_visualizer.py

# Alternatively with curl
curl -L https://raw.githubusercontent.com/Mass-Gap/UIDT-Framework-v3.7.2-Canonical/main/Supplementary_Scripts/uidt_visualizer.py -o uidt_visualizer.py
\end{verbatim}
}
