...
The 3.75σ tension with FLAG 2024 is fully resolved by the transition to the $\overline{\text{MS}}$ scheme. The QED self-energy correction ($\Delta m_{EM,u} = -0.36$ MeV) lowers the physical mass to 2.08 MeV, collapsing the tension to a consistent 0.75σ.
