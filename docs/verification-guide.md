...
This guide provides step-by-step instructions for independently verifying all claims in the UIDT v3.7.2 framework. All verification scripts are included in this repository under [verification/](../verification/).
...
@misc{Rietz2025_Verified,
  ...
  title  = {UIDT v3.7.2 - Independently Verified},
...
2. **Open GitHub Issue:**
   - Go to: https://github.com/badbugsarts-hue/UIDT-Framework-v3.7.2-Canonical/issues
