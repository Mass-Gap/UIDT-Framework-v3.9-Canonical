...
### UIDT v3.7.1 — Yang-Mills Mass Gap Proof
...
The complete text of the CC BY 4.0 license is available at:
...
@misc{Rietz2025,
  ...
  title        = {A Constructive Proof of the Yang-Mills Mass Gap 
...
This work references and builds upon established results in quantum field theory, including:

- Lattice QCD glueball masses (Morningstar & Peardon 1999, Chen et al. 2006)
- Functional Renormalization Group (Wetterich 1993)
- BRST cohomology (Becchi, Rouet, Stora, Tyutin 1976)
- Osterwalder-Schrader axioms (1973, 1975)

These references are cited in `REFERENCES.bib` and are used under fair use for academic purposes.
...
**Copyright © 2025 Philipp Rietz. All rights reserved under CC BY 4.0.**
